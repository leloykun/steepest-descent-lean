...
lemma aStar_measurable
  ...
  intro t
  simpa [aStar] using S.lmo_measurable.comp (S.C_measurable t)
...
lemma W_measurable
  ...
  | succ t ih =>
      have hEq :
        ...
        funext ω
        simpa [aStar, C] using S.update_eq t ω
      rw [hEq]
...
lemma grad_measurable
  ...
  intro t
  simpa [grad] using S.fGrad_measurable.comp (S.W_measurable t)
...
private theorem W_prefixMeasurable_before
  ...
  | succ s ih =>
      ...
      have hEq :
        ...
        funext ω
        simpa [aStar, C] using S.update_eq s ω
      rw [hEq]
